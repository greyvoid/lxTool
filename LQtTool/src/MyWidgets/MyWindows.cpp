...
void CMyMainWindow::setTitleOperateIcon(QString strImgClose, QString strImgNormal, QString strImgMin)
{
...
void CMyMainWindow::setTitleIcon(QString strIcon)
{
    m_labelTitleIcon->setPixmap(QPixmap(strIcon).scaled(m_labelTitleIcon->size()));
}

void CMyMainWindow::setTitle(QString strTitle)
{
...
//自己实现的窗口拖动操作
void CMyMainWindow::mousePressEvent(QMouseEvent *event)
{
...
void CMyMainWindow::mouseMoveEvent(QMouseEvent *event)
{
...
void CMyMainWindow::mouseReleaseEvent(QMouseEvent *event)
{
    isMousePressed=false;
}

void CMyMainWindow::initTitleBar()
{
    ...
    myPushButton *smallBtn=new myPushButton(tr("_"));
    myPushButton *closeBtn=new myPushButton(tr("X"));
...
void CMyMainWindow::initMenuBar()
{
...
void CMyMainWindow::initToolBar()
{
...
void CMyMainWindow::initCentralWidget()
{
