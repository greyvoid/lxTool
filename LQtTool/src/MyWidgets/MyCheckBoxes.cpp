...
MyCheckBox::MyCheckBox(const QString &strText, QString strImgBg, QString strImgChecked, QWidget *parent)
    : QWidget(parent)
    , m_strText(strText)
    , m_strImgBg(strImgBg)
...
void MyCheckBox::setChecked(bool bChecked)
{
    m_bChecked = bChecked;
    update();
}
